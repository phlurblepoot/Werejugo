...
import { api, type CustomIcon, type FamilySettings, type ItemKind, type PinSettings, type PinStyle } from "../api/client";
import { KIND_LABELS, BASE_PIN, defaultColor, defaultIcon, defaultPinStyle } from "../lib/style";
